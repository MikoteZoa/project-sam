...
export default class MovieGenre extends Component {
   ...
   render() {
      ...
      if (this.props.url === "/discover/tv?api_key=3fc3ee4672b6d17d3a7edd56dd787f0f&with_networks=213") {
         netflixUrl = true;
      }
      ...
      return (
         <>
            <div
               ...
               <img src={this.props.posterUrl} className="movieShowcase__container--movie-image" alt=""/>
            </div>
